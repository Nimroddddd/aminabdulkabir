...
function Intro() {
  return (
    <div className="flex flex-col items-center gap-3 mt-32 mx-14">
      ...
      <BlurText text="Amin Abdulkabir" className="text-7xl font-lobster pb-14 text-primary-text" delay={100} />
      <GradientText
        ...
        className="text-3xl" // Add one or more custom classes
      >
      Fullstack Developer.
      </GradientText>
      <p className='text-2xl'>Ever passionate and vibrant about combining frontends and backends to make ideas become reality</p>
