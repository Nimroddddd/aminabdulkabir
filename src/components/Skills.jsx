...
function Skills() {
  ...
  function displaySkills(skill, index) {
    ...
    return(
      <div key={index} className="flex flex-col justify-center items-center py-2 px-1 md:py-6 w-20 md:w-28 md:h-36 hover:scale-110 duration-500" onMouseOver={handleMouseOver} onMouseLeave={handleMouseLeave} style={{color: mouseOn ? skill.color : "black", borderColor: mouseOn ? skill.color : "#fff"}}>
        {skill.icon}
