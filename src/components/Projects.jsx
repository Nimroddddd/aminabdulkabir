      ...
      <div className="w-72 sm:w-96 pb-5 hover:scale-110 duration-500 shadow-2xl rounded" key={index}>
        ...
        <div className="px-5">
          ...
          <div className="flex justify-between mt-8 text-base sm:text-xl">
            <a href={project.live} target="_blank"><button className=" h-10 w-24 sm:w-32 bg-blue-200 hover:bg-blue-300 rounded">Live <ArrowOutwardIcon /></button></a>
            <a href={project.code} target="_blank"><button className="border-2 border-blue-200 h-10 w-24 sm:w-32 hover:bg-blue-200 duration-300" >Code {project.github}</button></a>
          </div>
        </div>
      </div>
    )
